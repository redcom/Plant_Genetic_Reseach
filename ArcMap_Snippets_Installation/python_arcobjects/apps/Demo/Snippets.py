# Snippets.py + Bio Tech Will's version
# ************************************************
# Updated for ArcGIS 10.5
# ************************************************
...
# need to be made for compatibility with ArcGIS 10.5:
# 1) Delete automation.pyc, automation.pyo, safearray.pyc, safearray.pyo
#  all of these files live in C:\Python27\ArcGIS10.5\Lib\site-packages\comtypes   
...
def GetLibPath():
    ...
    import _winreg
    # change string to latest ArcGIS string (Desktop10.x)
    keyESRI = _winreg.OpenKey(_winreg.HKEY_LOCAL_MACHINE, "SOFTWARE\\ESRI\\Desktop10.5")
...
def GetApp(app="ArcMap"):
    ...
    Execute GetStandaloneModules() first"""
